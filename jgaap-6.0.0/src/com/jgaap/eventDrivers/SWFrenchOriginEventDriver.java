 ...
 * 
 */
public class SWFrenchOriginEventDriver extends EventDriver {


    @Override
    public String displayName(){
    	return "SW French Origin";
    }
    
    @Override
    public String tooltipText(){
    	return "Special words of French origin";
    }

    @Override
    public String longDescription(){
    	return "Special words of French origin from Doctor Petrovic.";
    }
    ...
    public SWFrenchOriginEventDriver() {
