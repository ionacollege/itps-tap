 ...
 * 
 */
public class SpecialWords2EventDriver extends EventDriver {


    @Override
    public String displayName(){
    	return "Special Words 2";
    }
    
    @Override
    public String tooltipText(){
    	return "More special words";
    }

    @Override
    public String longDescription(){
    	return "Special words from Doctor Petrovic.";
    }
    ...
    public SpecialWords2EventDriver() {
