...
public class CLI {
	...
	static Option leaveOneOutExperimentEngine = OptionBuilder
						.withArgName("file")
						.hasArg()
						.withDescription("Batch processing, pass in a csv file of experiments for leave one out")
						.withLongOpt("leaveoneoutexperimentengine").create("el");
	...
	static {
		...
		options.addOption(leaveOneOutExperimentEngine);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		if (cmd.hasOption('h')) {
			...
			ExperimentEngine.runExperiment(eeFile, false);
			System.exit(0);
		} else if (cmd.hasOption("el")) {
			String eeFile = cmd.getOptionValue("el");
			ExperimentEngine.runExperiment(eeFile, true);
			System.exit(0);
		} else {
