...
public class LoadExperimentException extends ExperimentRunException {
	/**
	 *
	 */
	private static final long serialVersionUID = 266405248469929032L;

	public LoadExperimentException(String message) {
		super(message);
	}
}
